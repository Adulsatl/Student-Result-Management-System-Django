        ...
        // Use your knowledge of assignment operators to make the following changes to the particles
        // Print the value of number to the console after each exercise to check your results
        // Pay attention to the changes made to the particles with each operation

        //1 : Declare a variable named 'number' and set it equal to a value greater than 50 and less than 300

        let number = 300;
        //console.log(number);
        //2 : Using one operation, change the value of number to 3 times itself
        number *= 3
        //console.log(number);
        //3 : Using one operation, change the value of number to the remainder of the current value of number divided by 200
        number %= 200
        //console.log(number);
        //4 : Using one operation, change the value of number to itself divided by 5
        number /= 5
        console.log(number);
        //5 : Using one operation, square the value of number. You are not allowed to use Math.Pow
            ...
            function go() {
                ...
                this.paint = {
                    circle: function (x, y, size, color) {
                        context.beginPath();
                        context.arc(x, y, size, 0, 50 * Math.PI, false);
